...
apex 
1 of 46
Salon Booking Platform – Project Submission
Inbox

Srinivas K <ramh28287@gmail.com>
Attachments
4 Sept 2026, 23:06
to apextechnovation
...
I am submitting my GlowBook – Salon Booking System project for your review.

Please find the project details below:

1. Source Code Repository
GlowBook GitHub Repository

2. Live Web Application
GlowBook Live Web Application

3. Mobile Application – Android APK
Download GlowBook Android APK

4. Admin Dashboard
The Admin Dashboard is available through the live web application.

5. API Documentation
Attached: GlowBook_API_Documentation.md

6. README
Attached: README_GlowBook.md
...
Salon Owner
Email: customer2@glowbook.com
Password: Test1234

Customer
Customers can register through the application and log in using their registered credentials.

The submitted project includes the customer booking flow, salon management, admin dashboard, authentication, appointment management, and API integration.
...
Thank you for submitting the assignment. We have received your submission and will review it. We will get back to you regarding the next steps.
